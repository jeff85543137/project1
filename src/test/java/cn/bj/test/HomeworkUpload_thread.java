...
public class HomeworkUpload_thread {
	...
	public static void main(String[] args) {
		...
		try {
			...
			for(int i = 0;i<numberOfSheets;i++){
				Tsave tsave = new Tsave(new ArrayList<Mobile>(),bean,workbook,i);
				tsave.run();
			}
	...
	public static class Tsave implements Runnable{

		List<Mobile> mobileList = null; 
		StuService bean = null;
		...
		public Tsave(List<Mobile> mobileList, StuService bean, Workbook workbook, int i) {
			super();
